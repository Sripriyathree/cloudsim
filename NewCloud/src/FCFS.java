		...
		Log.printLine("Starting FCFS...");
	        ...
	        try {
	        	// First step: Initialize the CloudSim package. It should be called
	            	...
	            	final FcfsBroker broker = createBroker();
	            	...
	            	broker.executingAHighPriorityJob();
	            	
	            	Runnable monitor = new Runnable() {
	    				@Override
	    				public void run() {
	    					CloudSim.pauseSimulation(7);
	    					while (true) {
